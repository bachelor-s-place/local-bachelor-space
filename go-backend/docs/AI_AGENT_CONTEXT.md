# BachelorsSpace — AI Agent Context & Constraints
...
|-------|-----------|---------------|
| **Go Module Name** | `bachelors_space` | Private module name — no VCS prefix. All imports start with `bachelors_space/internal/...` |
| Language | **Go** | 1.22+ |
...
|----------|--------|--------|
| Go module name | `bachelors_space` | Private module; name TBD; all imports use this prefix |
...
| 7 | **Squad System** | Full squad lifecycle + `GET /squads/mine` (added May 2026) | ✅ |
| 8 | **Transactions & Payments** | Token payment flow; Razorpay integration | 🔲 |
| 9 | **Messages** | Squad private chat (PostgreSQL, cursor-paginated) | ✅ |
